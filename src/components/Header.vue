<template>
  <header
    ...
    <nav
      ...
      <div class="md:order-3 flex items-center gap-x-3">
        ...
        <div class="md:hidden">
          <button type="button"
            ...
            @click="toggleMobileMenu" aria-expanded="false" aria-controls="hs-navbar-floating-dark"
      ...
      <!-- Mobile Menu Overlay -->
      <div v-if="mobileMenuOpen" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-40 md:hidden"
        @click="toggleMobileMenu"></div>

      <!-- Mobile Menu -->
      <div v-if="mobileMenuOpen" id="hs-navbar-floating-dark"
        ...
        <div class="container mx-auto px-6 py-6">
          ...
          <div class="space-y-1 mb-6">
            <a href="#home" @click.prevent="scrollToSection('home'); toggleMobileMenu()"
            ...
            <a href="#about" @click.prevent="scrollToSection('about'); toggleMobileMenu()"
              class="block text-center py-3 px-4 text-neutral-300 hover:text-[#ff0] hover:bg-[#28391F]/50 rounded-lg transition-all duration-200">
              About
            </a>
            <a href="#services" @click.prevent="scrollToSection('services'); toggleMobileMenu()"
              class="block text-center py-3 px-4 text-neutral-300 hover:text-[#ff0] hover:bg-[#28391F]/50 rounded-lg transition-all duration-200">
              Services
            </a>
            <a @click="$emit('toggle-modal', true); toggleMobileMenu()"
              class="block cursor-pointer text-center py-3 px-4 text-neutral-300 hover:text-[#ff0] hover:bg-[#28391F]/50 rounded-lg transition-all duration-200">
              Career
            </a>
          </div>
          ...
          <div class="border-t border-neutral-600 pt-4">
            <button href="#contact-us" @click.prevent="scrollToSection('contact-us'); toggleMobileMenu()"
